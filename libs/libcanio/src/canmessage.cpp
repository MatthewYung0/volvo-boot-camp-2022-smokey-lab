...
void CanMessage::SetGearNeutral() { this->frame.data[GEAR] = 2; }
void CanMessage::SetGearPark() { this->frame.data[GEAR] = 0; }
void CanMessage::SetGearDrive() { this->frame.data[GEAR] = 3; }
void CanMessage::SetGearRear() { this->frame.data[GEAR] = 1; }
void CanMessage::SetPedalPosUp() { this->frame.data[PEDAL_POS] = 1; }
void CanMessage::SetPedalPosDown() { this->frame.data[PEDAL_POS] = 2; }
