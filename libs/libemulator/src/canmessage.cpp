...
scpp::CanFrame CanMessage::GetFrame() { return this->frame; }

void CanMessage::SetIgnition() {
  this->ignition_state = !(this->ignition_state);
  this->frame.data[IGNITION] = this->ignition_state;
}
void CanMessage::SetGearNeutral() { this->frame.data[GEAR] = 0; }
void CanMessage::SetGearPark() { this->frame.data[GEAR] = 1; }
void CanMessage::SetGearDrive() { this->frame.data[GEAR] = 8; }
void CanMessage::SetGearRear() { this->frame.data[GEAR] = 2; }
